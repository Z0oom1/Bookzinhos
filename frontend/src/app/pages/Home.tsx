  ...
  return (
    <div className="min-h-screen bg-background pb-32">
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-8">
        ...
        {/* Banner Principal */}
        <div className="relative h-40 rounded-[2rem] overflow-hidden bg-gradient-to-tr from-[var(--primary)] via-[var(--peach)] to-[var(--lavender)] shadow-[0_10px_30px_rgba(243,168,184,0.2)] animate-scale-in border border-white/20">
